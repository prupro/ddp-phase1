...
soon around the globe [1]. It is well established that 4G
...
and cognitive radio networks [1]–[3].

\subsection{Organization of this report}
All links/references to equation or figures are clickable.
...
Simulations were done on MATLAB. 
Given $\lambda_1$ and $\lambda_2$, 

\subsection{Simulation Setting}

$P_{s,i} = P_{r,i}; P_{s,i}^b = P_{s,i}^m$ and $P_{s,i}^{m_1} = \beta_1 P_{s,i}^m$ and $P_{s,i}^{m_2} = (1-\beta_1) P_{s,i}^m$ are allocated optimally to maximize the transmission rate of the active user. To do this, rate is expressed as a function of $\beta_1$ and minimized negative rate using MATLAB tool \textit{fminrnd}
